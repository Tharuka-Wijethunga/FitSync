  ...
  return (
    <div style={styles.container}>
      <div style={styles.formContainer}>
        <h2>Login to FitSync</h2>
        <form onSubmit={handleSubmit}>
          <div style={styles.inputGroup}>
            <label htmlFor="email">Email Address (as username)</label>
            <input
              type="email"
              id="email"
              name="email"
        ...
        <p style={styles.linkText}>
          Are you a coach? <Link to="/coach-login">Login here</Link>
        </p>
      </div>
    </div>
  );
...
const styles = {
    ...
    button: { width: '100%', padding: '10px', background: '#28a745', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '16px' },
